...
export async function listAgents(params: AgentQueryParams = {}): Promise<PaginatedResponse<Agent>> {
  ...
  return apiClient.get<PaginatedResponse<Agent>>('/api/identity/admin/agents', { params: queryParams });
}
...
export async function getAgent(agentId: string): Promise<AgentDetails> {
  return apiClient.get<AgentDetails>(`/api/identity/admin/agents/${agentId}`);
}
...
export async function approveAgent(
  ...
  // Execute action
  const result = await apiClient.post<Agent>(`/api/identity/admin/agents/${agentId}/approve`, {
    reason,
...
export async function suspendAgent(
  ...
  // Execute action
  const result = await apiClient.post<Agent>(`/api/identity/admin/agents/${agentId}/suspend`, {
    reason,
    durationDays,
    correlationId: actionBase.correlationId,
  });
...
export async function reactivateAgent(
  ...
  // Execute action
  const result = await apiClient.post<Agent>(`/api/identity/admin/agents/${agentId}/reactivate`, {
    reason,
    correlationId: actionBase.correlationId,
  });
...
export async function rejectAgent(
  ...
  // Execute action
  const result = await apiClient.post<Agent>(`/api/identity/admin/agents/${agentId}/reject`, {
    reason,
    correlationId: actionBase.correlationId,
  });
